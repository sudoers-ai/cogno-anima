"""
cogno_core.llm.bedrock_backend — AWS Bedrock LLM backend (Converse API).
...
Optional dependency: ``pip install "cogno-core[bedrock]"`` (or ``boto3``).
"""
...
logger = logging.getLogger("cogno_core.llm.bedrock")
...
class BedrockBackend:
    ...
    def _get_client(self):
        ...
        try:
            ...
            raise ImportError('boto3 not installed. Run: pip install "cogno-core[bedrock]"') from exc
