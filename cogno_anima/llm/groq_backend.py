"""
cogno_anima.llm.groq_backend — Groq LLM backend (ultra-fast OpenAI-compatible API).
...
from cogno_anima.llm.openai_backend import _openai_tool_call, _safe_close

logger = logging.getLogger("cogno_anima.llm.groq")
