"""
cogno_anima.llm.factory — resolve a "provider:model" string to a backend.
...
from cogno_anima.errors import MissingAPIKeyError
...
def create_backend(
    ...
    *,
    ...
    from cogno_anima.llm.ollama import OllamaBackend
