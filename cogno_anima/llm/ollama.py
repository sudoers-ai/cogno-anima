...
from cogno_anima.llm.base import LLMBackend, Embedder
from cogno_anima.utils import cosine_similarity

logger = logging.getLogger("cogno_anima.llm.ollama")
...
class OllamaEmbedder(Embedder):
    ...
    wrap it in ``CachingEmbedder`` (cogno_anima.llm.cache) to add a bounded LRU
